...
export default function LegalBattlesError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('[OMEN/legal-battles] Error:', error);
  }, [error]);

  return (
    <div className="container" style={{ paddingTop: '3rem' }}>
      <h1 style={{ fontSize: '1.25rem', marginBottom: '1rem' }}>Failed to load Legal Battles.</h1>
